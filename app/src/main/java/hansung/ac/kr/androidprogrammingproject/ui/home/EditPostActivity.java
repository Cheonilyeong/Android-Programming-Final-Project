...
public class EditPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_showDay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View dialogView = View.inflate(EditPostActivity.this, R.layout.dialog_day, null);
                AlertDialog.Builder dlg = new AlertDialog.Builder(EditPostActivity.this);
        ...
        btn_showTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View dialogView = View.inflate(EditPostActivity.this, R.layout.dialog_time, null);
                AlertDialog.Builder dlg = new AlertDialog.Builder(EditPostActivity.this);
                dlg.setView(dialogView);
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rg.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(EditPostActivity.this, "분야를 선택하세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(str_et_food.equals("") || str_et_food.trim().equals("")) {
                    Toast.makeText(EditPostActivity.this, "음식을 입력하세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                // 본문 확인
                ...
                if(sp_person.getSelectedItemPosition() == 0) {
                    Toast.makeText(EditPostActivity.this, "인원을 선택하세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(str_tv_day.equals("")) {
                    Toast.makeText(EditPostActivity.this, "날짜를 선택하세요", Toast.LENGTH_SHORT).show();
                    return;
                }
                // 시간 확인
                String str_tv_time = tv_time.getText().toString();
                if(str_tv_time.equals("")) {
                    Toast.makeText(EditPostActivity.this, "시간을 선택하세요", Toast.LENGTH_SHORT).show();
                    return;
                }

                // 게시물 수정
                FirebaseDatabase database = FirebaseDatabase.getInstance();
                DatabaseReference databaseRef = database.getReference("project").child("Post").child(post_id);

                Post post = new Post(post_id, LoginActivity.u_id, str_et_title, str_rb_checked, str_et_food, str_et_content, str_sp_person, str_tv_day, str_tv_time);
